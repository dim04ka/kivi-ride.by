...
<section class="koncept">
  <div class="container">
    <h1>Концепция</h1>
    <p>Ничто так не объединяет людей, как изоляция и непрерывный темп жизни.</p>
    <p>Концепция сервиса «Kivi ride» отображает непрерывное движение, развитие себя и своего бизнеса в Минске и других городах. В чем заключается наша миссия? Всего несколько кликов, и мы решим все Ваши запросы: такси, доставка на авто или пешим курьером. Мы готовы поддержать Вас в тяжелое время.
