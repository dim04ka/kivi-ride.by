  ...
  <div class="container">
    <div class="main-row">
      <div class="main-col main-col-logos">
        ...
        <div class="main-disc">
          Сервис работает в тестовом режиме. Оплата наличными и на расчетный счет. Для подробностей звоните менеджеру <a href="tel:375296620272">+375&nbsp;29&nbsp;662&nbsp;02&nbsp;72</a>
        </div>
      </div>
      <div class="main-col main-col-form">
        ...
        <div class="main-forms">
          <div class="main-dev devilery active">
            <form action="" class="form form-send1">
              ...
              <div class="form-wrapper">
                <div class="field">
                  <input class="field-input pickup-point" type="text" name="point" placeholder="Забрать улица/дом/корпус " required>
                  <input class="field-input field-input-podezd" name="pointEntrance" type="text" placeholder="Подъезд/этаж">
                  <input class="field-input field-input-kv" type="text" name="pointRoom" placeholder="Кв/офис">
                </div>
                <div class="field">
                  <input class="field-input" type="text" name="point" placeholder="Доставить улица/дом/корпус">
                  <input class="field-input field-input-podezd" type="text" name="pointEntrance" placeholder="Подъезд/этаж">
                  <input class="field-input field-input-kv" type="text" name="pointRoom" placeholder="Кв/офис">
                </div>
          ...
          <div class="main-dev devilerytaxi">
            <form action="" class="form form-send2">
          ...
          <div class="main-dev taxi">
            <form action="" class="form form-send3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var startHour = moment().format('HH');
        var startMinutes = moment().format('mm');

        if (+startMinutes < 50 && +startMinutes >= 20) {
            startHour = +startHour + 1;
            startMinutes = '00';
        } else if (+startMinutes >= 50) {
            startHour = +startHour + 1;
            startMinutes = '30';
        } else if (+startMinutes < 20) {
            startMinutes = '30';
        }
        ...
        $('.dropdown .dropdown-menu li').click(function () {
            ...
            if ($(this).parents('.dropdown').find('.date').length) {
                console.log($(this).parents('.dropdown').find('.date'));
                if ($(this).attr('id') === moment().format('DD MMMM')) {
                    liArray = '';
                    ...
                    $('.minF').parents('.dropdown').find('span').text('Сейчас');
                    $('.minF').parents('.dropdown').find('input').attr('value', 'Сейчас');
                    ...
                    $('.minF').parents('.dropdown').find('span').text('00:00');
                    $('.minF').parents('.dropdown').find('input').attr('value', '00:00');
                }
